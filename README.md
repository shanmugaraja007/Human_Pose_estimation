...
You should now see the empty Gazebo world:
...
You should see a pose skeleton visualization:
...
This publishes your custom video stream to /image_raw for YoloPose processing.
...
Now your robot should react to gestures detected by YoloPose v8:
